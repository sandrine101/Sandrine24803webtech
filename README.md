 E-commerce STOREWALA
![e_commerce](https://github.com/user-attachments/assets/ee8f0aee-b230-4e5e-8d0e-5e723727317b)
https://sandrine-webtech.onrender.com/
...
Installation
To install and run this project, you'll need to have Java and Maven installed on your computer, as well as a MySQL 8 server. Then, follow these steps:

Clone or download this repository.
Create a new database on your MySQL server and update the spring.datasource.url, spring.datasource.username, and spring.datasource.password properties in the src/main/resources/application.properties file to match your MySQL server configuration.
Navigate to the project directory and run mvn clean install to build the project.
Run java -jar target/storewala-0.0.1-SNAPSHOT.jar to start the application.
